...
<div class=\"page-content\">
    ...
    <tbody>
        ...
        if ($this->env->isDebug()) {
            // line 24
            \Symfony\Component\VarDumper\VarDumper::dump((isset($context["ranking"]) || array_key_exists("ranking", $context) ? $context["ranking"] : (function () { throw new RuntimeError('Variable "ranking" does not exist.', 24, $this->source); })()));
        }
        // line 25
        echo "        ";
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["ranking"]) || array_key_exists("ranking", $context) ? $context["ranking"] : (function () { throw new RuntimeError('Variable "ranking" does not exist.', 25, $this->source); })()));
        $context['loop'] = [
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["player"]) {
            ...
            <td scope=\"col\"><a href=\"";
            // line 28
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("profile", ["id" => twig_get_attribute($this->env, $this->source, $context["player"], "id", [], "any", false, false, false, 28)]), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["player"], "pseudo", [], "any", false, false, false, 28), "html", null, true);
            echo "</a></td>
            <td scope=\"col\">";
            // line 29
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["player"], "count_victory", [], "any", false, false, false, 29), "html", null, true);
            echo "</td>

            <td scope=\"col\">Il y a ";
            // line 31
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["player"], "last_login", [], "any", false, false, false, 31), "html", null, true);
            echo "</td>
        </tr>
        ";
            ++$context['loop']['index0'];
...
";
    ...
    {
        return array (  165 => 34,  148 => 31,  143 => 29,  137 => 28,  133 => 27,  130 => 26,  112 => 25,  109 => 24,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
