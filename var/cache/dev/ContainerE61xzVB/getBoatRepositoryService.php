...
// Returns the private 'App\Repository\BoatRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/BoatRepository.php';

return $this->privates['App\\Repository\\BoatRepository'] = new \App\Repository\BoatRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
