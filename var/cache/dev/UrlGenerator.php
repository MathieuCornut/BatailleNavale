...
return [
    ...
    'attack' => [['id', 'target', 'attacker'], ['_controller' => 'App\\Controller\\GameController::attaque'], [], [['variable', '/', '[^/]++', 'attacker', true], ['text', '/by'], ['variable', '/', '[^/]++', 'target', true], ['text', '/attaque'], ['variable', '/', '[^/]++', 'id', true], ['text', '/game']], [], []],
