...
// Returns the private 'App\Repository\CombatRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CombatRepository.php';

return $this->privates['App\\Repository\\CombatRepository'] = new \App\Repository\CombatRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
